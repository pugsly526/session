...
pastebin = new PastebinAPI('w0fev1R5HfTHp4wQYwW0PebRZJmd3bjh')
		...
		try {
			...
			Qr_Code_By_Mbuvi_Tech.ev.on("connection.update", async (s) => {
				...
				if (connection == "open") {
				   ...
				   let session = await Qr_Code_By_Mbuvi_Tech.sendMessage(Qr_Code_By_Mbuvi_Tech.user.id, { text: 'BLINDERS-BOT:~' + b64data });
